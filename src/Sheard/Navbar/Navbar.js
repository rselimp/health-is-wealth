...
const Navbar = () => {
  ...
  const menuItems = <>
    ...
    <li><Link to='/cardprice'>Pricing</Link></li>
    ...
    <div className="navbar bg-base-200 flex justify-between">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-200 rounded-box w-52 text-4xl">
            {menuItems}
          </ul>
        </div>
        <Link className="btn btn-ghost normal-case text-xl  lg:text-4xl text-[#13C5DD]"><span><FaHospital /></span> <span className='ml-2 '>Health is Wealth</span></Link>
      </div>
