...
const Footer = () => {
  return (
    <div className='mt-14'>
      <footer className="footer p-10 text-white bg-[#1D2A4D]">
        <div className=''>
      ...
      <footer className="footer px-10 py-4 border-t bg-[#1D2A4D] text-white border-base-300">
        <div className="items-center grid-flow-col">
          ...
          <p>Health is Wealth Hospital. <br />Providing reliable tech since 1992</p>
        </div>
